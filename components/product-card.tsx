      ...
      <motion.div
        ...
        <motion.div
          ...
          <div style={{padding:'16px 20px 28px'}}>
            ...
            <p style={{fontSize:12,color:'var(--blue)',fontWeight:600,marginBottom:12}}>
              {p.volumen}
            </p>
            ...
            <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',
              ...
              <div style={{display:'flex',alignItems:'center',gap:16}}>
                ...
                <button onClick={()=>setQty(qty+1)}
                  style={{width:36,height:36,borderRadius:12,background:'#1E6FAE',
      ...
      <motion.div
        ...
        <div style={{position:'relative',paddingTop:'72%',overflow:'hidden'}}>
          ...
          <div style={{position:'absolute',bottom:10,left:12,
            ...
            <span style={{fontSize:10,color:'rgba(255,255,255,.6)'}}>MXN</span>
          </div>
        ...
        <div style={{padding:'12px 14px 14px'}}>
          ...
          <button
            onClick={e=>{e.stopPropagation();add({id:p.id,nombre:p.nombre,precio:p.precio});toast.success('Agregado 💧')}}
            style={{
              width:'100%',height:38,
              background:'linear-gradient(135deg,#1E6FAE,#155789)',
            ...
            <span style={{fontSize:16}}>+</span> Pedir
          </button>
        </div>
      </motion.div>

      {/* Modal via portal — funciona en Next.js */}
      {mounted && open && (
